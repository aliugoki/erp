...
export const FEATURE_MODULES: FeatureModuleDef[] = [
  ...
  },
  {
    ...
    description:
      'Restaurant vertical (fine dining / QSR / café / cloud kitchen / food court / buffet / drive-thru / delivery): menu & modifiers, visual floor plan, tablet & QR ordering, kitchen display (KDS), recipe→inventory COGS, own + aggregator delivery, reservations, and dynamic provincial fiscalization (PRA/FBR/SRB/KPRA/BRA). Reuses inventory, finance GL, CRM, HR, tax, notifications and realtime.',
    dependsOn: ['inventory', 'finance', 'crm'],
    features: [
      { key: 'restaurant.menu', name: 'Menu, modifiers & combos' },
      { key: 'restaurant.floor', name: 'Floor plan & tables' },
      { key: 'restaurant.orders', name: 'Orders & POS (dine-in/QSR/drive-thru)' },
      { key: 'restaurant.kds', name: 'Kitchen Display System' },
      { key: 'restaurant.recipes', name: 'Recipes & inventory COGS' },
      { key: 'restaurant.delivery', name: 'Delivery & driver tracking' },
      { key: 'restaurant.reservations', name: 'Reservations & waitlist' },
      { key: 'restaurant.fiscal', name: 'Dynamic tax-authority fiscalization (PRA/FBR/…)' },
      { key: 'restaurant.reports', name: 'Restaurant reports & dashboards' },
    ],
  },
  {
    key: 'production',
