...
export const PERMISSION_CATALOG: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'restaurant:delivery:run', label: 'Ride deliveries (own runs only — the rider app)' },
      { key: 'restaurant:driver:manage', label: 'Manage the rider roster' },
      { key: 'restaurant:customer:manage', label: 'Manage customers & their addresses' },
