/**
 * A minimal circuit breaker (Chunk 6.5). Wraps a remote call so a failing dependency fails FAST once
 * it's clearly down, instead of hammering it (and tying up request threads) on every call.
 *
 * States:
