...
export const MODULE_NAV: Record<string, NavItem> = {
  ...
  pharmacy: { key: 'pharmacy', label: 'Pharmacy', href: '/pharmacy', icon: Pill },
  restaurant: { key: 'restaurant', label: 'Restaurant', href: '/restaurant', icon: UtensilsCrossed },
  ecommerce: { key: 'ecommerce', label: 'Online Store', href: '/ecommerce', icon: ShoppingBag },
  helpdesk: { key: 'helpdesk', label: 'Help Desk', href: '/helpdesk', icon: LifeBuoy },
  subscriptions: { key: 'subscriptions', label: 'Subscriptions', href: '/subscriptions', icon: Repeat },
